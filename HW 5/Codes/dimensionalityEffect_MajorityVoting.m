...
title('Accuracy Based on Dimensionality for Multi-Classifier Fusion with Majority Voting')
...
title('Precision Based on Dimensionality for Multi-Classifier Fusion with Majority Voting');
xlabel('DIMENSION','fontweight','bold','fontsize',10);
