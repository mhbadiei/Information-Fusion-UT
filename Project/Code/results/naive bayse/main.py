...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        print(file_name)
        accuracy.append(100*model.unary_predict('test_set/' + file_name))
        #model.print_table()
    #print(accuracy)
    plt.figure()
    plt.plot([x+1 for x in range(10)] ,accuracy,'-',label='unigram model')
    ...
    for i in range(10):
        ...
        file_name = 'test_file' + str(i+1) +'.txt'
        print(file_name)
        accuracy.append(100*model.binary_predict('test_set/' + file_name))
        #model.print_table()
    #print(accuracy)
    #plt.figure()
    plt.plot([x+1 for x in range(10)] ,accuracy,'-',label='bigram model')
    plt.xlabel("ITERATION")
    plt.ylabel("ACCURACY (%)")  
    plt.ylim((0,100))
    plt.title('Naive Bayes Classifier')
    ...
    plt.show()
    #model.print_table()
    #model.binary_back_off_predict('test_set')
    #model.print_table()
